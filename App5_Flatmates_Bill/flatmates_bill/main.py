...
# Create the FIRST flatmates_bill
flatmate1_name = input("Enter the name of the first flatmates_bill: ")
...
# Create the SECOND flatmates_bill
flatmate2_name = input("Enter the name of the first flatmates_bill: ")
